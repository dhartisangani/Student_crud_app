...
const { addstudent, getAllStudents, getStudentByID, getStudentWithSerchandPagination, updateStudentwithID, deleteStudent, getStudentsByDivision } = require('../Controller/studentController');
...
const StudentWithdivision = process.env.GET_STUDENT_WITH_DIVISION
...
// Get student as per division wise
router.get(StudentWithdivision,authToken, getStudentsByDivision);
